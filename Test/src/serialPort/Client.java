...
public class Client extends Frame{
	...
	Image icon = toolKit.getImage(Client.class.getResource("icon.png"));
	...
	public void paint(Graphics g) {
		...
		g.drawString("欢迎使用探针设备实时监控系统", 45, 190);
		
		g.setFont(new Font("微软雅黑", Font.ITALIC, 26));
		g.setColor(Color.BLACK);
		g.drawString("Version：1.0   Powered By：Yinhe", 280, 260);
